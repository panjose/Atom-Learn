...
7. **Other threats.** Behaving in other ways that threaten the well-being of
   our community.
...
To report a possible violation, contact the lead maintainer `@panjose` through a
private contact method listed on the [maintainer's GitHub profile](https://github.com/panjose).
Do not report conduct incidents in a public issue. If no private contact method
is available, send a content-free request for a private reporting channel before
sharing incident details.

Community Moderators take reports of violations seriously and will make every
effort to respond in a timely manner. They will investigate reports by reviewing
relevant messages, logs, recordings, or witness accounts. Moderators will keep
...
communication to the whole community may be part of a mutually agreed
resolution.

## Addressing and Repairing Harm

If an investigation finds that this Code of Conduct has been violated, the
following enforcement ladder may be used based on the incident's impact. Lower
rungs may be skipped for serious violations.

1. **Warning**
   - Event: a violation involving a single incident or series of incidents.
   - Consequence: a private, written warning.
   - Repair may include a private apology, acknowledgement of responsibility,
     and clarification of expectations.
2. **Temporarily Limited Activities**
   - Event: a repeated violation after a warning, or the first incidence of a
     more serious violation.
   - Consequence: a private warning with a time-limited cooldown period for
     particular channels or interactions.
   - Repair may include an apology, reflection during the cooldown, and a
     thoughtful return to community spaces.
3. **Temporary Suspension**
   - Event: repeated violations that warnings did not resolve, or one serious
     violation.
   - Consequence: a private suspension notice with conditions for return.
   - Repair includes respecting the suspension and satisfying the stated return
     conditions.
4. **Permanent Ban**
   - Event: a repeated pattern that other steps failed to resolve, or a
     violation so serious that community safety cannot otherwise be preserved.
   - Consequence: access to community spaces and communication channels is
     removed.
   - Repair: there is no possible repair at this level.

This ladder is a guideline and does not limit the moderators' discretion in the
