...
- Exact-tag release recovery can rerun the complete platform matrix for an existing unpublished immutable tag, recursively discovers downloaded runtime bundles, reports actionable asset-count diagnostics, and refuses to replace an existing GitHub Release.
